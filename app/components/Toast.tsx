...
export function ToastContainer() {
  ...
  return (
    // On narrow screens, stretch from edge to edge with equal margins; on wider screens pin to the right
    <div className="fixed top-4 left-4 right-4 sm:left-auto sm:right-4 z-50 flex flex-col gap-2 sm:max-w-sm w-auto">
      {toasts.map((toast) => (
